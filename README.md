<div align="center">
  <img src="docs/assets/pastel-app-icon.png" width="148" alt="Pastel App Icon">
  <h1>Pastel</h1>
  <p><strong>为 macOS 打造的原生 IPA 历史版本下载工具</strong></p>
  <p>搜索 App、查找历史版本，并将 IPA 轻松传输到 iPhone 或 iPad。</p>

  <p>
    <img src="https://img.shields.io/badge/version-20260901-0A84FF?style=flat-square" alt="Version 20260901">
...
> **2026 年 9 月 1 日更新通知**
>
> Pastel 20260901 修复了部分 Mac 可能生成 `020000000000` 无效设备 GUID 的问题，并会自动淘汰相关旧会话。此版本为强制更新，请务必安装最新版。详情请参阅 [Issue #42](https://github.com/EEliberto/IPA-Download/issues/42)。
